...
public class EventBlockDestroyEvent extends EventBlockEvent implements Cancellable {
    private static final HandlerList handlers = new HandlerList();

    private boolean cancelled;
    public EventBlockDestroyEvent(SateEvent event, IEventStage stage, IEventBlock block) {
